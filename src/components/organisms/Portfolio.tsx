    ...
    <div className='snap-start h-screen lg:px-12 xl:px-32'>
      <div className='flex lg:justify-between h-full tracking-[0.7rem] items-center font-title text-[#333333]'>
        <div className='flex items-center mx-auto lg:mx-0'>
          ...
          <div className='hidden lg:block lg:w-0.5 lg:h-96 lg:mx-12 bg-[#333333]'></div>
        ...
        <div className='hidden lg:block h-screen lg:w-[21rem] lg:mr-12 relative'>
          ...
          <div className='absolute lg:w-96 lg:h-80 border-solid border-2 border-[#333333] opacity-60 lg:-left-6 lg:top-64'></div>
        </div>
      </div>
    </div>
  );
